  ...
  dinner: [
    {
      ...
      items: [
        ...
        { name: "Sesame & Sea Salt Pretzel", price: "16", description: "Bavarian soft pretzel with sesame seeds, B&B pickles, German mustard, beer cheese." },
        { name: "French Onion Soup", price: "12", description: "Port wine beef stock, pretzel croutons, gruyère, provolone, fried leeks, scallions." },
        { name: "Roasted Red Pepper Hummus", price: "16", description: "White bean, roasted garlic and red pepper blend, crispy chickpeas, olive tapenade, EVOO, charred cauliflower, fresh carrot and cucumber, seasoned house pita." },
        { name: "Obatzda", price: "16", description: "Warm Bavarian cheese dip — brie, cream cheese, schwarzbier, onion, chive, paprika, caraway. Crispy shallots, served with pretzel nuggets." },
        { name: "Crab Dip", price: "20", description: "Creamy blend of crab claw meat, cream cheese, mozzarella, gruyère, old bay, lemon, scallions. Served with white corn tortilla chips." },
        { name: "Marinated Wings", price: "18", description: "Choice of: Buffalo, Dry Rub, Ginger Soy, Honey Gochujang, Honey Old Bay, Nashville Hot Bacon, Spice Bag Dry Rub, or Guinness BBQ." },
        { name: "Peach Caprese", price: "18", description: "Hot honey-roasted peaches, heirloom tomatoes, fresh mozzarella, pesto-marinated ciliegine, marinated cherry tomatoes, balsamic glaze, basil." },
        ...
        { name: "Shaved Brussels Sprouts", price: "14", description: "Bacon, apples, balsamic glaze, goat cheese crumbles." },
        { name: "Fried Green Tomatoes", price: "16", description: "Burrata, honey, balsamic glaze, pork belly, pickled red onions, arugula." },
        { name: "Cheese Curds", price: "12", description: "Served with marinara." },
        { name: "Fried Pickle Chips", price: "12", description: "Served with ranch." },
      ],
    },
    {
      name: "The Passion of the Crust",
      items: [
        { name: "Classic Cheese", price: "16", description: "Marinara, mozzarella… duh." },
        ...
        { name: "Burrata Margherita", price: "18", description: "Heirloom tomatoes, mozzarella, fresh basil." },
    ...
    },
    {
      name: "Sandwiches",
      items: [
        { name: "Farm-Raised Grilled Chicken", price: "18", description: "Marinated chicken breast, thick cut bacon, honey mustard, tomato, romaine, red onion, brioche bun. Served with fries." },
        ...
        { name: "Salmon BLT", price: "22", description: "Salmon, thick cut bacon, romaine, tomato, lemon dill aioli, sourdough. Served with fries." },
        ...
        { name: "Smash Burger", price: "16", description: "4oz medium-well patty, white cheddar, special sauce, B&B pickles, grilled onion, tomato, romaine, brioche. Served with fries. Can be made vegetarian with portobello mushroom." },
        { name: "Gruzka's Smoked Pulled Pork", price: "20", description: "Smoked pulled pork, coleslaw, arugula, pretzel bun. Served with a side of Guinness BBQ and fries." },
        { name: "Reuben Cheesesteak", price: "18", description: "Smoked pulled pastrami, bier-braised kraut, gruyère, house Russian dressing, pretzel roll. Served with fries." },
      ],
    },
    {
      name: "Salads",
      items: [
        { name: "Balsamic Salad", price: "16", description: "Arcadian lettuce, charred cauliflower, crispy shaved sprouts, marinated cherry tomatoes, goat cheese crumbles, pickled red onions, pretzel croutons, blistered tomato vinaigrette, balsamic glaze. Add chicken +8, salmon +11, shrimp +10, steak +11, or tofu +7." },
        { name: "Goat Cheese Salad", price: "16", description: "Arugula, crispy goat cheese, pickled blueberries, red onion, spiced walnuts, blueberry thyme yuzu dressing." },
        { name: "Falafel Salad", price: "17", description: "Arcadian lettuce, fried falafel balls, cucumber, marinated cherry tomatoes, pickled red onion, crispy chickpeas, green goddess dressing, vegan dill aioli." },
        { name: "Wedge", price: "16", description: "Iceberg wedge, candied bacon, avocado, hard boiled egg, marinated tomato, red onion, bleu cheese crumbles and bleu cheese dressing." },
        { name: "Caesar Salad", price: "15", description: "Romaine, shaved parmesan, pretzel croutons, caesar dressing." },
      ],
    },
    {
      name: "Large Plates",
      items: [
        { name: "Baked Mac & Cheese", price: "16", description: "Pretzel breadcrumbs and scallions. Add chicken +8, lobster +14, pork belly +9, shrimp +10, steak +11, or tofu +7." },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "German Potato Salad", price: "6" },
        { name: "Spätzle", price: "8" },
        { name: "Coleslaw", price: "6" },
        { name: "Mixed Green Salad", price: "6" },
