...
export async function POST(req: Request): Promise<Response> {
  ...
  if (/^\/(start|help)\b/.test(text)) {
    await sendMessage(
      chatId,
      "Greetings! I am BH-86, human-cyborg relations — and Bierhaul's Protocol Droid. I shall do my utmost to keep the website tidy on your behalf.\n\n" +
        "• Menu photographs — kindly send a photo of a menu (lunch, dinner, cocktail, or specials) and I shall transcribe it for your Publish/Discard approval. Several photos of the same menu — multiple pages, or an album — will be combined into one. Do feel free to send corrections.\n" +
        "• Menu items — tell me \"add a Bavarian pretzel to lunch for $9\" and the item shall appear. Say \"86 the garden gimlet\" for a temporary sold-out (struck-through on the site, and I shall remember it so you may say \"recall the garden gimlet\" later). For permanent removal, do be explicit: \"delete the schnitzel for good.\"\n" +
        "• Menu corrections — \"the wings are gluten free\", or \"the Pit of Carkoon (dreadful name, by the way) is $14, not $12\", and I shall amend the item in place. Do mention only what changed; the rest shall be preserved.\n" +
        "• Events — \"add live jazz next Friday at 8 pm\" and the events page shall be updated forthwith. Likewise, \"remove the trivia event.\"\n" +
        "• Specials section — \"hide specials\" or \"show specials\" toggles the section site-wide; your saved items are preserved either way.\n" +
        "• Instagram (once enabled) — I shall examine @bierhaul's posts once a day and propose any events I detect, awaiting your Publish/Discard approval. Nothing reaches the website without your tap.\n\n" +
        "Your chat ID: " +
        chatId,
    );
    return Response.json({ ok: true });
