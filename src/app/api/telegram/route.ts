  ...
  if (/^\/(start|help)\b/.test(text)) {
    await sendMessage(
      ...
      "Greetings! I am BH-86, human-cyborg relations — and Bierhaul's Protocol Droid. I shall do my utmost to keep the website tidy on your behalf.\n\n" +
        ...
        "• Menu corrections — \"the wings are gluten free\", or \"the Pit of Carcoon (dreadful name, by the way) is $14, not $12\", and I shall amend the item in place. Do mention only what changed; the rest shall be preserved.\n" +
